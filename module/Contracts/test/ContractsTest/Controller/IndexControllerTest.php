...
class IndexControllerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetContractsTableReturnsAnInstanceOfContractsTable()
    {
    	$this->assertInstanceOf('Contracts\Model\ContractsTable', $this->controller->getContractsTable());
    }
